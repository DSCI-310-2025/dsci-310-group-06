...
-   `roc_auc_value`: ROC AUC value; measure of the model's effectiveness in distinguishing between classes. The ROC curve and confusion matrix are visualised below (Fig. 2, 3). The confusion matrix displays the quantity of each type of prediction result; The model predicts 23910 true positive, 22188 true negative, 7789 false negative and 9533 false positive cases (Fig. 3).
