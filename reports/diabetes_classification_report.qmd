...
In the original `raw_diabetes_df` dataset, approximately `r percent_no_diabetes2`% of individuals do not have diabetes, resulting in heavily imbalanced classes (@tbl-diabetes_2).
...
After balancing, the distribution of individuals in both categories of `Diabetes_binary` is roughly `r percent_no_diabetes3` - `r percent_diabetes3` (@tbl-diabetes_3). A summary of the class distribution before and after ROSE can be seen in @tbl-diabetes_4 below.
