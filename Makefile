...
# From 04-analysis.R
work/output/lasso_metrics.csv work/output/roc_curve.png work/output/cm_plot.png: work/src/04-analysis.R work/data/processed/diabetes_test.csv work/output/lasso_tuned_wflow.RDS 
