...
# Checking for NA values, distinct counts of each variable, and the current data type # CONVERT TO FUNCTION (33-37)
...
# Converting categorical/binary variables into factors # CONVERT TO FUNCTION (43-44)
raw_diabetes_df <- raw_diabetes_df %>%
  dplyr::mutate(dplyr::across(!BMI, ~ factor(.)))

# Checking to see how unbalanced the dataset is with respect to the target variable # CONVERT TO FUNCTION (47-50)
