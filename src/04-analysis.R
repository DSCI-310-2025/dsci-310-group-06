...
Usage: 04-analysis.R --file_path_test=<file_path_test> --file_path_wflow=<file_path_wflow> --output_path_lasso=<output_path_lasso> --output_path_roc=<output_path_roc> --output_path_cm=<output_path_cm> --output_path_cm_df=<output_path_cm_df> --output_path_coeff=<output_path_coeff>
Options: 
...
coeff_plot <- predictdiabetes::coeff_plot(lasso_tuned_wflow)
...
predictdiabetes::cm_plot(cm_df, opt$output_path_cm) # Create matrix image
