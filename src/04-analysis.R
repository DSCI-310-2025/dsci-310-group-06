...
lasso_model_outputs <- diabetes_test %>%
...
roc_plot(
  model_outputs=lasso_model_outputs, 
...
cm <- yardstick::conf_mat(lasso_model_outputs, truth = Diabetes_binary, estimate = .pred_class, event_level = "second")
